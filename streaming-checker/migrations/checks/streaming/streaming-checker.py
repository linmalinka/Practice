...
def load_info_from_cloudera(service_name: str) -> dict:
    ...
    # TODO: проверка существования  сервиса <-->
...
#def is_streaming_started_and_good(info: dict) -> bool:
...
#def is_rollback_required_or_not_required(service_name: str) -> bool:
...
def apply_rollback_to_kafka(service_name: str, rollback_time: datetime.datetime) -> None:
    ...
    timestamp_ms = int(rollback_time.timestamp() * 1000)  # можно ли не писать *1000 метод?
